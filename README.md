...
! [Histogram] (https://github.com/RuzickaJiri/tp-proteomics/blob/main/hist.png) "Superposition de l'histogramme et la loi de probabilité"
...
![Volcano plot] (https://github.com/RuzickaJiri/tp-proteomics/blob/main/volc.png) "Volcano plot"
